...
@section('title', 'Admin Panel - Savol tahrirlash')
...
<div class="p-6">
    <div class="mb-6">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-800">Savol tahrirlash</h1>
    ...
    <div class="bg-white rounded-lg shadow">
        <form action="{{ route('admin.units.questions.update', [$unit, $question]) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="question_text" name="question_text" rows="4" required
                              class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('question_text', $question->question_text) }}</textarea>
                </div>
